<template>
  ...
  <div class="card">
    ...
    <div class="tech-grid">
      <div class="tech-item"><span class="tech-name">Vue 3</span><span class="tech-desc">Frontend framework</span></div>
      <div class="tech-item"><span class="tech-name">Vite</span><span class="tech-desc">Build tool</span></div>
      <div class="tech-item"><span class="tech-name">Vue Router</span><span class="tech-desc">Client-side routing</span></div>
      <div class="tech-item"><span class="tech-name">Lucide</span><span class="tech-desc">Icon set</span></div>
    </div>
  </div>
</template>
